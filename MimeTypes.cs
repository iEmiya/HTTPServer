...
namespace HTTPServer
{
    public static class MimeTypes
    {
        ...
        private static readonly IDictionary<string, string> TypeMap;

        private class MyMap : IDictionary<String, String>
        {
            private readonly Dictionary<String, String> a = new Dictionary<String, String>(StringComparer.OrdinalIgnoreCase);
            ...
            public void Add(string key, string value)
            {
                ...
                {
                    Log.Warn(ex, "Failed to add: " + key + "=" + value);
                }
            }
